        ...
        <form class="form-signin" action="../../controller/Manager.php" method="POST">
          ...
          <div class="row"> 
            <div class="form-group">
              <label for="nameUser" class="sr-only">User</label>
              <input type="hidden" name="module" value="login"/>
              <input type="text" id="nameUser" name="nameUser" class="form-control" placeholder="Usuário" required autofocus>
            </div>
          </div>

          <div class="row"> 
            <div class="form-group">
              <label for="passwordUser" class="sr-only">Senha</label>
