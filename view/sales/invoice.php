...
echo "<div class='div-separator'></div>";
echo "<div>
            <span class='span-invoice-id'>#</span>
...
for ($i = 0; $i < count($valuationUnitSales); $i++) {
    ...
    echo "<div>
                <span class='span-invoice-id'>" . ($i + 1) . "</span>
...
$methodsPayment = array('', 'À vista', 'Cartão - Dábito', 'Cartão - Crédito');
echo "<div class='div-separator'></div>";
