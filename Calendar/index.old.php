...
<body>
	<div id="agenda">
		<?php
			...
			echo "<h2>Agenda para ".$meses[$mesactual]." de ".$elanio."</h2>";
			echo $mostrar;
			...
			echo "<tr><th>Segunda</th><th>Terça</th><th>Quarta</th><th>Quinta</th><th>Sexta</th><th>Sábado</th><th>Domingo</th></tr><tr>";
			$j=1;
			$filita=0;
			...
			for ($i=1;$i<=$diasdespues;$i++)
			{
				...
				if ($i>=$primeromes && $i<=$tope) 
				{
					...
					if ($noagregar==false) echo "'>$j<a href='../view/index.php?date=$compuesta'><img src='add.png' /></a>";
			...
			echo "<p>&laquo; <a href='".$_SERVER["PHP_SELF"]."?fecha=$mesanterior'>Mes Anterior</a> - <a href='".$_SERVER["PHP_SELF"]."?fecha=$messiguiente'>Mes Seguinte</a> &raquo;</p>";
			?>
	</td></tr></table>
	<script type="text/javascript">
